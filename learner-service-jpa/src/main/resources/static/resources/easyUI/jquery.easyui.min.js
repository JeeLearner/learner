...
_15c.removeClass("tree-fileupload").addClass("tree-folder tree-folder-open");
...
node.find(".tree-icon").removeClass("tree-folder").addClass("tree-fileupload");
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon tree-fileupload "+(item.iconCls?item.iconCls:"")+"\"></span>");
}
}
...
opts.oldValue="";
var file=$("<input type=\"fileupload\" class=\"textbox-value\">").appendTo(_509.filebox);
...
if(_900.hasClass("tree-fileupload")){
_900.removeClass("tree-fileupload").addClass("tree-folder tree-folder-open");
...
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon tree-fileupload "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("tree-folder").addClass("tree-fileupload");

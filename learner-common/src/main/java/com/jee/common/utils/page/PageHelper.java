 ...
 * the License.
 */
package com.jee.common.utils.page;
...
public class PageHelper {
     ...
     * </p>
     */
    public static long getTotal() throws Exception {
        if (isPageable()) {
            return LOCAL_PAGE.get().getTotal();
        } else {
            throw new Exception("The current thread does not start paging. Please call before PageHelper.startPage");
        }
    }
     ...
     * </p>
     */
    public static long freeTotal() throws Exception {
        long total = getTotal();
        // 释放资源
        remove();
        return total;

package com.jee.demo.reflect;

import com.jee.demo.reflect.base.Person;
...
public class ReflectDome {
    ...
    public void init() throws Exception {
        className = "com.jee.demo.reflect.base.Person";
    ...
    public void getPublicConstructor() throws Exception {
        ...
        Person person = (Person)constructor.newInstance(1L, "非私有构造函数");
    ...
    public void getPrivateConstructor() throws Exception {
        ...
        Person person = (Person) con.newInstance("私有构造函数");
    ...
    public void getNotPrivateField() throws Exception {
        ...
        field.set(obj, "lisi");
        System.out.println(field.get(obj)); //lisi
        System.out.println(obj.toString()); //Person [id=100, name=lisi]
    }
    ...
    public void getPrivateMethod() throws Exception {
        ...
        Object value = method.invoke(obj);  //method方法  obj类   value返回值
    ...
    public void otherMethod() throws Exception {
        ...
        System.out.println("log4j-" + personClass.getResourceAsStream("/log4j.properties"));
        ...
        System.out.println(Class.forName("com.jee.demo.reflect.base.CityEmum").isEnum());

        //判断当前的Class对象表示是否是接口
        System.out.println(personClass.isInterface());
        System.out.println(Class.forName("com.jee.demo.reflect.base.TestInterface").isInterface());
    }
